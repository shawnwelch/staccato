...
from staccato_backend.api.serializers import analysis_out, video_out
from staccato_backend.auth import Identity, require_identity
from staccato_backend.db import get_session
from staccato_backend.deps.entitlements import (
    EntitlementInfo,
    consume_free_analysis,
    get_entitlement,
)
from staccato_backend.engine import ENGINE_VERSION
from staccato_backend.jobs import QUEUE_INTERACTIVE
from staccato_backend.jobs.tasks import analyze_url
from staccato_backend.models import Analysis, AnalysisSource, AnalysisStatus, SharePage, Video
from staccato_backend.providers import normalize_any_url
from staccato_backend.schemas import (

...
from asl_backend.jobs import QUEUE_BATCH, QUEUE_INTERACTIVE, app
...
from asl_backend.providers import ChannelVideoRef, NormalizedVideo, get_provider
from asl_backend.storage import get_storage
...
async def analyze_url(analysis_id: str) -> None:
    ...
    async with sessionmaker() as session:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix="asl-") as tmp:

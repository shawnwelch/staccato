...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_file=".env", env_prefix="ASL_", extra="ignore")
    ...
    database_url: str = "sqlite+aiosqlite:///./asl_dev.sqlite3"
    ...
    clerk_jwks_url: str = ""
    clerk_issuer: str = ""
    # Static bearer token for /admin (Clerk org-gating happens in asl-admin;

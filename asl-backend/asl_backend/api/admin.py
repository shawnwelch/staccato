"""Internal ops endpoints consumed by asl-admin (Bearer ADMIN_API_TOKEN).
...
from asl_backend.auth import require_admin
...
from asl_backend.jobs import QUEUE_BATCH
from asl_backend.jobs.tasks import analyze_url, classify_channel
...
from asl_backend.providers import get_provider

...
import asl_backend.jobs.tasks as tasks_module
from asl_backend.jobs import app as procrastinate_app
from asl_backend.models import Channel, ChannelScore
from asl_backend.providers import ChannelVideoRef, NormalizedVideo, VideoMetadata
...
async def test_channel_classification_pipeline(client, admin_headers, monkeypatch):
    ...
    import asl_backend.api.admin as admin_module

  ...
  const description =
    data.analysis.label != null
      ? `${data.analysis.label} pacing — median shot ${formatSeconds(
        ...
        )}, ${data.analysis.cuts_per_minute?.toFixed(1) ?? "—"} cuts/min. Measured by ASL.`
      : "Shot-pacing measurement by ASL.";
  return {
    title: pageTitle,
    description,
    openGraph: {
      ...
      <div className="ctaBlock">
        <div>
          ...
          <div className="small dim">
            Measure any video&apos;s pacing with the ASL iOS app.
          </div>
        </div>
